    ...
    <div class="_2rRcbVfc_0">
      <div class="_38zlilu2_0">
        <div class="_2i2klQV__0">
          <h2 class="_1PSgy0gU_0">${detail.column_title}</h2>
          <div class="iconfont _1ifqWM06_0"></div>
        </div>
        <div class="_1fAY5-KW_0">
          <div>${detail.column_unit} · ${detail.update_frequency}</div>
          <div class="I-xpAFyI_0"><span class="iconfont _1nSwuFAm_0"></span> <span class="_27yP89wS_0">${detail.sub_count}</span>
          </div>
        </div>
      </div>
